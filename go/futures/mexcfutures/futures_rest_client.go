...
func (c *FuturesRestClient) GetContractDetailCountry(ctx context.Context, symbol string) (*RawResponse, error) {
	params := map[string]interface{}{}
	if symbol != "" {
		params["symbol"] = symbol
	}
...
func (c *FuturesRestClient) CreateOrder(ctx context.Context, params map[string]any) (*RawResponse, error) {
	if getStringParam(params, "symbol") == "" {
		return nil, fmt.Errorf("params.symbol required")
	}
...
func (c *FuturesRestClient) GetStpSearch(ctx context.Context) (*RawResponse, error) {
